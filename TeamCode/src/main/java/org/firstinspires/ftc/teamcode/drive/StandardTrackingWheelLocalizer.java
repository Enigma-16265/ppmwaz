...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.249329317097857; // in; distance between the left and right wheels //13.317714478691085
    public static double FORWARD_OFFSET = 6.25; // in; offset of the lateral wheel
    public static double X_MULTIPLIER = .99794937; // Multiplier in the X direction 1.004107
    public static double Y_MULTIPLIER = 1.00160475; // Multiplier in the Y direction 1.002098
